...
from qtpy_task_runner.actions_executor import TaskStatus

if TYPE_CHECKING:
    from qtpy.QtGui import QMouseEvent

    from qtpy_task_runner.actions_executor import FileActionsExecutor, Task
...
if __name__ == "__main__":
    ...
    if not TYPE_CHECKING:
        try:
            from qtpy_filedialog.filesystem.file_browser.file_system_executor import FileActionsExecutor  # type: ignore
        except ImportError:
            FileActionsExecutor = None  # type: ignore
